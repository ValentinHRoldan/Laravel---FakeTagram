    ...
    <div class="md:flex  md:justify-center md:gap-1 md:items-center">
        ...
        <div class="md:w-4/12 bg-white text-black p-6 rounded-lg shadow">
            <form action="{{route('registro')}}" method="POST">
                ...
                <br>
                <input type="submit" value="Crear Cuenta" class="bg-sky-700 hover:bg-sky-800 transition-colors cursor-pointer uppercase font-bold w-full p-4 rounded-lg text-white">
            </form>
        </div>  
    </div>
